...
% The margin before the caption is a bit bigger
\providecommand\attachmentcaptionscaler{1.3}

\newcommand\attachmentcaptionskip{\attachmentcaptionscaler\dimexpr\attachmentmargin}
...
% the wheel.
\setlength{\abovecaptionskip}{\attachmentcaptionskip}
